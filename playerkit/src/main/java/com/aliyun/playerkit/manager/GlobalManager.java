...
public class GlobalManager {
    ...
    private GlobalManager() {
        throw new UnsupportedOperationException("Cannot instantiate GlobalManager");
    }
     ...
     * 设置业务来源信息
     * <p>
     * 写入全局能力识别数据（组件身份），数据由 {@link ScenarioManager#buildGlobalExtraData()} 统一生成。
     * </p>
     */
    private static void setExtraData() {
        String extraData = ScenarioManager.buildGlobalExtraData();
        AliPlayerGlobalSettings.setOption(AliPlayerGlobalSettings.SET_EXTRA_DATA, extraData);
        LogHub.i(TAG, "Set extra data", extraData);
    }
